...
@JsonSerializable()
@immutable
abstract class VideoMessageModel extends MessageModel {
  /// Creates a video message.
  const VideoMessageModel._({
  ...
  const factory VideoMessageModel({
  ...
  factory VideoMessageModel.fromJson(Map<String, dynamic> json) {
    return _$VideoMessageModelFromJson(json);
  }

  /// Converts an video message to the map representation, encodable to JSON.
  @override
  Map<String, dynamic> toJson() {
    return _$VideoMessageModelToJson(this);
  }

  /// Creates a full video message from a partial one.
  factory VideoMessageModel.fromPartial({
    required ChatUser author,
    int? createdAt,
    required String id,
    required PartialVideoModel partialVideo,
    String? remoteId,
    String? roomId,
    bool? showStatus,
    Status? status,
...
class _VideoMessage extends VideoMessageModel {
  const _VideoMessage({
    required super.author,
    super.createdAt,
    super.height,
